  ...
  <header>
            ...
            <div class="menu-area">
                <div class="limit-box">
                  ...
                  <ul class="menu-area-main">
                    ...
                    <form class="form-inline my-2 my-lg-0" style = "margin-left: 400px " action="<?php echo base_url('Welcome/RechercheFronts'); ?>" method="POST">
    ...
    <div class="limiter">
        ...
        <div class="table100 ver5 m-b-110">
                  ...
                  <th class="cell100 column5" style = "text-align: center">Membre</th>
								</tr>
							</thead>
						</table>
					</div>
                ...
                <?php for ($i=0; $i < count($diss); $i++) { ?>
                    ...
                    <td class="cell100 column1">
                          <form class="news" action=<?php echo base_url('Login/versInfoDissoute/'); ?> method="POST">
                            <input type="hidden" name="idCooperativeDissout" value="<?php echo $diss[$i]['idCooperativeDissout'];?>" >
                            <button class="submit" name="" style= "background : transparent; color : gray; font-size : 18px; font-family : Calibri Light">
                              <?php echo $diss[$i]['nomCooperative']; ?>
                            </button>
                          </form>
                        </td>
