<?php
  $testeImage = "../assets/SaryInfo/".$liste['prenomEmployee'].".jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          <h1 class="fw-light"><?php echo $liste['nomEmployee']; echo " ";echo $liste['prenomEmployee'] ?> </h1>
          <ul class="theme-list">
            <li><b>Fonction:</b> <?php echo $liste['fonctionEmployee']; ?></li>
            <li><b>Contact:</b> <?php echo $liste['contactEmployee']; ?></li>
            <li><b>E-Mail:</b> <?php echo $liste['mailEmployee']; ?></li>
            <li><b>Expérience:</b> <?php echo $liste['experience']; ?></li>
          </ul>
        </div>
      </div>
    </div>
