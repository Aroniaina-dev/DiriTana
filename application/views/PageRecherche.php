...
<body class="main-layout">
  ...
  <header>
                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                      <li class="active"> <a href="<?php echo base_url('Welcome/index'); ?>">Return</a> </li>
                    </ul>
                        <form class="form-inline my-2 my-lg-0" style = "margin-left: 300px " action="<?php echo base_url('Welcome/Recherche'); ?>" method="POST">
    ...
    <!-- table -->
    <h1>Liste recherche coopérative</h1>
    <div class="limiter">
						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th class="cell100 column2">Activite Principal</th>
									<th class="cell100 column3">Ressort Territorial</th>
									<th class="cell100 column4">Dernier PV</th>
									<th class="cell100 column5">President</th>
                                    <th class="cell100 column6">Modif</th>
                                    <th class="cell100 column7">/Suppr</th>
								</tr>
							</thead>
						</table>
					</div>
							...
							<tbody>
                                <?php for ($i=0; $i < count($rechercheCoop); $i++) { ?>
                                    <tr class="row100 body">
                                        <td class="cell100 column1"><?php echo $rechercheCoop[$i]['nomCooperative']; ?></td>
                                        <td class="cell100 column2"><?php echo $rechercheCoop[$i]['activitePrincipale']; ?></td>
                                        <td class="cell100 column3"><?php echo $rechercheCoop[$i]['ressortTerritorial']; ?></td>
                                        <td class="cell100 column4"><?php echo $rechercheCoop[$i]['dernierPV']; ?></td>
                                        <td class="cell100 column5"><?php echo $rechercheCoop[$i]['nomPresident']; ?><?php echo " "; ?><?php echo $rechercheCoop[$i]['prenomPresident']; ?></td>
                                        <td class="cell100 column6"> 
                                        <form class="news" action=<?php echo base_url('Login/ModifCoop/'); ?> method="POST">
                                            <input type="hidden" name="id" value="<?php echo $rechercheCoop[$i]['idCooperative'];?>" >
                                        ...
                                        <td class="cell100 column7">
                                            ...
                                            <input type="hidden" name="nomCooperative" value="<?php echo $rechercheCoop[$i]['nomCooperative'];?>" >
                                            <input type="hidden" name="addrescooperative" value="<?php echo $rechercheCoop[$i]['addrescooperative'];?>" >
                                            <input type="hidden" name="telephonecooperative" value="<?php echo $rechercheCoop[$i]['telephonecooperative'];?>" >
                                            <input type="hidden" name="mailcooperative" value="<?php echo $rechercheCoop[$i]['mailcooperative'];?>" >
                                            <input type="hidden" name="activitePrincipale" value="<?php echo $rechercheCoop[$i]['activitePrincipale'];?>" >
                                            <input type="hidden" name="ressortTerritorial" value="<?php echo $rechercheCoop[$i]['ressortTerritorial'];?>" >
                                            <input type="hidden" name="mandat" value="<?php echo $rechercheCoop[$i]['mandat'];?>" >
                                            <input type="hidden" name="dernierPV" value="<?php echo $rechercheCoop[$i]['dernierPV'];?>" >
                                            <input type="hidden" name="nomPresident" value="<?php echo $rechercheCoop[$i]['nomPresident'];?>" >
                                            <input type="hidden" name="prenomPresident" value="<?php echo $rechercheCoop[$i]['prenomPresident'];?>" >
						...
						<table>
							<tbody>
                                <?php for ($i=0; $i < count($rechercheEmpl); $i++) { ?>
                                    <tr class="row100 body">
                                        <td class="cell100 column1"><?php echo $rechercheEmpl[$i]['nomEmployee']; ?></td>
                                        <td class="cell100 column2"><?php echo $rechercheEmpl[$i]['prenomEmployee']; ?></td>
                                        <td class="cell100 column3"><?php echo $rechercheEmpl[$i]['fonctionEmployee']; ?></td>
                                        <td class="cell100 column4"><?php echo $rechercheEmpl[$i]['experience']; ?></td>
