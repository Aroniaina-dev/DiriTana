...
<head>
    ...
    <link href="<?php echo base_url('assets/Login/css/templatemo-diagoona.css'); ?>" rel="stylesheet" />
<!--
                ...
                <main class="tm-col-right">
                    <section class="tm-content">
                        <div class="media my-3 mb-5 tm-service-media tm-service-media-img-l">
                            <img src="<?php echo base_url('assets/img/ServiceLogin1.jpg'); ?>" alt="Image" class="tm-service-img">
                        ...
                        <div class="media my-3 mb-5 tm-service-media">                            
                            ...
                            <img src="<?php echo base_url('assets/img/ServiceLogin2.jpg'); ?>" alt="Image" class="tm-service-img-r">
                        </div>
                        <div class="media my-3 tm-service-media tm-service-media-img-l">
                            <img src="<?php echo base_url('assets/img/ServiceLogin3.jpg'); ?>" alt="Image" class="tm-service-img">
                            <div class="media-body tm-service-text">
