      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="main-navbar">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url('Login/retour'); ?>" class="nav-link" data-animate="scrolling">Return</a>
            </li>
          </ul>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          ...
          <ul class="theme-list">
            ...
            <li><b>Mandat:</b> <?php echo $coop['mandat']; ?><?php echo " ans"; ?></li>
            <li><b>Date à jour:</b> <?php echo $coop['dateAJour']; ?></li>
          ...
          <form class="news" action=<?php echo base_url('Login/ModifCoop/'); ?> method="POST">
            <input type="hidden" name="id" value="<?php echo $coop['idCooperative'];?>" >
            <button class="btn btn-theme-outline">Modifier</button>
          </form>
          <form class="news" action=<?php echo base_url('Login/deleteCooperative/'); ?> method="POST">
              <input type="hidden" name="idCooperative" value="<?php echo $coop['idCooperative'];?>" >
              <input type="hidden" name="nomCooperative" value="<?php echo $coop['nomCooperative'];?>" >
              <input type="hidden" name="ce" value="<?php echo $coop['CE'];?>" >
              <input type="hidden" name="de" value="<?php echo $coop['DE'];?>" >
              <input type="hidden" name="dc" value="<?php echo $coop['DC'];?>" >
              <input type="hidden" name="mandat" value="<?php echo $coop['mandat'];?>" >
              <input type="hidden" name="dateAJour" value="<?php echo $coop['dateAJour'];?>" >
              <input type="hidden" name="nomPresident" value="<?php echo $coop['nomPresident'];?>" >
              <input type="hidden" name="membre" value="<?php echo $coop['membre'];?>" >
              <input type="hidden" name="homme" value="<?php echo $coop['homme'];?>" >
              <input type="hidden" name="femme" value="<?php echo $coop['femme'];?>" >
              <input type="hidden" name="contact" value="<?php echo $coop['contact'];?>" >
              <input type="hidden" name="branche" value="<?php echo $coop['branche'];?>" >
              <input type="hidden" name="filiere" value="<?php echo $coop['filiere'];?>" >
              <input type="hidden" name="addrescooperative" value="<?php echo $coop['addrescooperative'];?>" >
              <input type="hidden" name="fokotany" value="<?php echo $coop['fokotany'];?>" >
              <input type="hidden" name="commune" value="<?php echo $coop['commune'];?>" >
              <input type="hidden" name="distric" value="<?php echo $coop['distric'];?>" >
              <input type="hidden" name="province" value="<?php echo $coop['province'];?>" >
              <input type="hidden" name="region" value="<?php echo $coop['region'];?>" >
              <input type="hidden" name="date2018" value="<?php echo $coop['date2018'];?>" >
            <button class="btn btn-theme-outline">Dissoute</button>
            </form>
        </div>
      </div>
    </div>
