            ...
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-3 col logo_section">
              <div class="full">
                <div class="center-desk">
                  <div class="logo">
                    <a href="#index"><h1 class="display-4">SRI</h1></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="carousel-caption">
                <div class="row">
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="text-bg">
                     <span>Welcome to SRI </span>
                      
                      <p>It's a pleaser for us to show you our evolution for our job, our strategic for all customers. Have a nice day ans good explore for you!!!!! </p>
                      <form class="Vegetable">
                        <input class="Vegetable_fom" placeholder="Cooperative" type="text" name=" Cooperative">
                        <button class="Search_btn">Search</button>
                      </form>
                        <a href="#">Contact Us</a> <a href="#">Cooperative</a>
                      </div>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="images_box">
                      <figure><img src="<?php echo base_url('assets/SaryGroupe/gp1.jpg'); ?>"></figure>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <<div class="container-fluid padding_dd">
              <div class="carousel-caption">
                <div class="row">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="images_box">
                      <figure><img src="<?php echo base_url('assets/SaryGroupe/gp2.jpg'); ?>"></figure>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="container-fluid padding_dd">
              <div class="carousel-caption">
                ...
                <button class="Search_btn">Search</button>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="images_box">
                      <figure><img src="<?php echo base_url('assets/SaryGroupe/gp3.jpg'); ?>"></figure>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="row">
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 padding_rl">
        <div class="about-box_img">
          <figure><img src="<?php echo base_url('assets/Admin/images/IMG_20210914_154251.jpg'); ?>" alt="#" /></figure>
        </div>
      </div>
    </div>
      ...
      <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 ">
       ...
       <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 ">
        <div class="vegetable_img">
         <figure><img src="<?php echo base_url('assets/SaryGroupe/gp3.jpg'); ?>" alt="#"/></figure>
         <span>01</span>
        </div>
      </div>
       <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 ">
        <div class="vegetable_img margin_top">
         <figure><img src="<?php echo base_url('assets/SaryGroupe/gp1.jpg'); ?>" alt="#"/></figure>
         <span>02</span>
        </div>
      </div>
    </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 pa_right">
                                        <div class="testomonial_img">
                                            <figure><img src="<?php echo base_url('assets/SaryTapaka/Matantsoa.jpg'); ?>" alt="#"/></figure>
                                            <i><img src="<?php echo base_url('assets/Admin/images/test_con.png'); ?>" alt="#"/></i>
                                        </div>
                                    </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
                      ...
                      <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="address">
                          ...
                          <ul class="Menu_footer">
                            ...
                            <li><a href="instagrm.com">Instagram</a> </li>
                            <li><a href="google.com">Linkdin</a> </li>
                          </ul>
                        </div>
                      </div>
              ...
              <div class="copyright">
                <div class="container">
                  <p>Copyright © 2021 Design by <a href="https://html.design/">Manda Aroniaina Nomenjanahary</a></p>
                </div>
              </div>
            </div>
          </footr>
