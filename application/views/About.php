                    ...
                    <div class="col-md-6">
                        <div class="about-img">
                            <div class="about-img-1">
                                <img src="<?php echo base_url('assets/img/IMG_20210914_154103.jpg');?>" alt="Image">
                            </div>
                ...
                <div class="row align-items-end">
                    <div class="col-md-6">
                        <div class="feature-img">
                            <img src="<?php echo base_url('assets/img/business-man.png');?>" alt="Image">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="section-header">
                            <p>Notre caractéristique</p>
                            <h2>Qui sommes-nous?</h2>
                        </div>
                        <p>
                            Notre service pour l'état "Antananarivo" avec nos agents pour des déscentes sur terrains, afin d'analiser les circonstances.
                        </p>
        ...
        <div class="team">
            <div class="container">
                <div class="section-header">
                    ...
                    <h2>Notre équipe de consultants professionnels</h2>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo base_url('assets/img/FB_IMG_16316239692722028.jpg');?>" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Chef Emma</h2>
                                <p>Chef de Service</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo base_url('assets/img/IMG_20210914_154138.jpg');?>" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Mme Tiana</h2>
                                <p>Ordre sec</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo base_url('assets/img/IMG_20210914_154103.jpg');?>" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Mr Matantsoa</h2>
                                <p>Chef de Service</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="<?php echo base_url('assets/img/IMG_20210914_154039.jpg');?>" alt="Team Image">
                            </div>
                            <div class="team-text">
                                <h2>Mme Mbola</h2>
                                <p>Membre</p>
