...
<head>
    ...
    <h1></h1>
        ...
        <div class="fact">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-6">
                        <div class="fact-item">
                            <img src="<?php echo base_url('assets/img/icon-4.png');?>" alt="Icon">
                            <h2>Qualified Team</h2>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="fact-item">
                            <img src="<?php echo base_url('assets/img/icon-1.png');?>" alt="Icon">
                            <h2>Individual Approach</h2>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="fact-item">
                            <img src="<?php echo base_url('assets/img/icon-8.png');?>" alt="Icon">
                            <h2>100% Success</h2>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="fact-item">
                            <img src="<?php echo base_url('assets/img/icon-6.png');?>" alt="Icon">
        ...
        <div class="testimonial">
            <div class="container">
                <div class="section-header">
                    <p>Carrousel de témoignages</p>
                    <h2>Avis clients 100% positifs</h2>
                </div>
