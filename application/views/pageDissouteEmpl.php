<?php
  for ($i=0; $i < count($diss); $i++){
      $testeImage[$i] = "../assets/SaryTapaka/".$diss[$i]['prenomEmployee'].".jpg";
      // echo $testeImage[$i];
  }
            ...
            <div class="menu-area">
                <div class="limit-box">
                  ...
                  <ul class="menu-area-main">
                    ...
                    <form class="form-inline my-2 my-lg-0" style = "margin-left: 400px " action="<?php echo base_url('Login/RechercheFronts'); ?>" method="POST">
    ...
    <div class="limiter">
        ...
        <div class="table100 ver5 m-b-110">
						...
						<table>
							<thead>
								<tr class="row100 head">
									<th class="cell100 column1" style="text-align: center">Name</th>
									<th class="cell100 column2" style="text-align: center">Lastname</th>
									<th class="cell100 column3" style="text-align: center">Function</th>
									<th class="cell100 column4" style="text-align: center">Experience</th>
									<th class="cell100 column5" style="text-align: center">Profil</th>
					...
					<div class="table100-body js-pscroll">
						<table>
							<tbody>
                <?php for ($i=0; $i < count($diss); $i++) { ?>
                    <tr class="row100 body">
                        <td class="cell100 column1">
                          <form class="news" action=<?php echo base_url('Login/versInfoDissouteEmpl'); ?> method="POST">
                          <input type="hidden" name="idEmployee" value="<?php echo $diss[$i]['idEmployee'];?>" >
                          <button class="submit" name="" style= "background : transparent; color : gray; font-size : 18px; font-family : Calibri Light">
                            <?php echo $diss[$i]['nomEmployee']; ?>
                          </button>
                        </td>
                        <td class="cell100 column2">
                          <form class="news" action=<?php echo base_url('Login/versInfoDissouteEmpl'); ?> method="POST">
                            <input type="hidden" name="idEmployee" value="<?php echo $diss[$i]['idEmployee'];?>" >
                            <button class="submit" name="" style= "background : transparent; color : gray; font-size : 18px; font-family : Calibri Light">
                              <?php echo $diss[$i]['prenomEmployee']; ?>
                            </button>
                        </td>
                        <td class="cell100 column3">
                          <form class="news" action=<?php echo base_url('Login/versInfoDissouteEmpl'); ?> method="POST">
                            <input type="hidden" name="idEmployee" value="<?php echo $diss[$i]['idEmployee'];?>" >
                            <button class="submit" name="" style= "background : transparent; color : gray; font-size : 18px; font-family : Calibri Light">
                              <?php echo $diss[$i]['fonctionEmployee']; ?>
                            </button>
                        </td>
