...
<body class="main-layout">
  ...
  <header>
    ...
    <!-- table -->
    <h1>Résultat recherche coopérative</h1>
    <div class="limiter">
        ...
        <div class="table100 ver5 m-b-110">
                ...
                <?php for ($i=0; $i < count($rechercheCoop); $i++) { ?>
                    ...
                    <td class="cell100 column1">
                          <form class="news" action=<?php echo base_url('Login/versInfoCoop/'); ?> method="POST">
                            <input type="hidden" name="idCooperative" value="<?php echo $rechercheCoop[$i]['idCooperative'];?>" >
                            <button class="submit" name="" style= "background : <?php echo $rechercheCoop[$i]['couleur'];?>; color : gray; font-size : 18px; font-family : Calibri Light">
                        ...
                        <td class="cell100 column7">
                            ...
                            <input type="hidden" name="ce" value="<?php echo $rechercheCoop[$i]['CE'];?>" >
                            <input type="hidden" name="de" value="<?php echo $rechercheCoop[$i]['DE'];?>" >
                            <input type="hidden" name="dc" value="<?php echo $rechercheCoop[$i]['DC'];?>" >
                            <input type="hidden" name="mandat" value="<?php echo $rechercheCoop[$i]['mandat'];?>" >
                            <input type="hidden" name="dateAJour" value="<?php echo $rechercheCoop[$i]['dateAJour'];?>" >
                            <input type="hidden" name="nomPresident" value="<?php echo $rechercheCoop[$i]['nomPresident'];?>" >
                            <input type="hidden" name="membre" value="<?php echo $rechercheCoop[$i]['membre'];?>" >
                            <input type="hidden" name="homme" value="<?php echo $rechercheCoop[$i]['homme'];?>" >
                            <input type="hidden" name="femme" value="<?php echo $rechercheCoop[$i]['femme'];?>" >
                            <input type="hidden" name="contact" value="<?php echo $rechercheCoop[$i]['contact'];?>" >
                            <input type="hidden" name="branche" value="<?php echo $rechercheCoop[$i]['branche'];?>" >
                            <input type="hidden" name="filiere" value="<?php echo $rechercheCoop[$i]['filiere'];?>" >
                            <input type="hidden" name="addrescooperative" value="<?php echo $rechercheCoop[$i]['addrescooperative'];?>" >
                            <input type="hidden" name="fokotany" value="<?php echo $rechercheCoop[$i]['fokotany'];?>" >
                            <input type="hidden" name="commune" value="<?php echo $rechercheCoop[$i]['commune'];?>" >
                            <input type="hidden" name="distric" value="<?php echo $rechercheCoop[$i]['distric'];?>" >
                            <input type="hidden" name="province" value="<?php echo $rechercheCoop[$i]['province'];?>" >
                            <input type="hidden" name="region" value="<?php echo $rechercheCoop[$i]['region'];?>" >
                            <input type="hidden" name="date2018" value="<?php echo $rechercheCoop[$i]['date2018'];?>" >
