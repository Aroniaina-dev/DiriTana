...
<body class="theme-red">
  ...
  <div class="vg-page page-home" id="home" style="background-image: url(<?php echo base_url('assets/info/img/bg_image_1.jpg'); ?>)">
    ...
    <div class="caption-header text-center wow zoomInDown">
      ...
      <h1 class="fw-light mb-4">to <b class="fg-theme">SRI</b> (DIRI_TANA)</h1>
    ...
    <div class="container mt-5">
        <h1 class="text-center fg-dark wow fadeInUp">Statistique par Branche</h1>
        <div class="row py-3">
            <div class="col-md-6">
                <h4 class="wow fadeInUp"></h4>
                <?php for ($i=0; $i < count($nbrbranche); $i++) { ?>
                    <div class="progress-wrapper wow fadeInUp">
                        <span class="caption"><?php echo $nbrbranche[$i]['Branche'] ; ?> : <?php echo $nbrbranche[$i]['count'] ; ?></span>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" style="width: <?php echo $branche[$i]; ?>%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><?php echo $branche[$i]; ?>%</div>
                        </div>
                    </div>
                <?php } ?>    
            </div>
    ...
    <div class="container mt-5">
        <h1 class="text-center fg-dark wow fadeInUp">Statistique par Filière</h1>
        <div class="row py-3">
            <div class="col-md-6">
                <h4 class="wow fadeInUp"></h4>
                <?php for ($i=0; $i < count($nbrfiliere); $i++) { ?>
                    <div class="progress-wrapper wow fadeInUp">
                        <span class="caption"><?php echo $nbrfiliere[$i]['Filiere'] ; ?> : <?php echo $nbrfiliere[$i]['count'] ; ?></span>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" style="width: <?php echo $filiere[$i]; ?>%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><?php echo $filiere[$i]; ?>%</div>
                        </div>
                    </div>
                <?php } ?>    
            </div>
    ...
    <div class="container mt-5">
        <h1 class="text-center fg-dark wow fadeInUp">Statistique par Commune</h1>
        <div class="row py-3">
            <div class="col-md-6">
                <h4 class="wow fadeInUp"></h4>
                <?php for ($i=0; $i < count($nbrcommune); $i++) { ?>
                    <div class="progress-wrapper wow fadeInUp">
                        <span class="caption"><?php echo $nbrcommune[$i]['Commune'] ; ?> : <?php echo $nbrcommune[$i]['count'] ; ?></span>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" style="width: <?php echo $commune[$i]; ?>%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"><?php echo $commune[$i]; ?>%</div>
                        </div>
                    </div>
                <?php } ?>    
            </div>
