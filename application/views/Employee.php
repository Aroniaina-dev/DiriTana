<?php
  for ($i=0; $i < count($liste); $i++){
      $testeImage[$i] = "../assets/SaryTapaka/".$liste[$i]['prenomEmployee'].".jpg";
      // echo $testeImage[$i];
  }
...
<body class="main-layout">
  ...
  <header>
    ...
    <div class="header-top">
            ...
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-3 col logo_section">
              <div class="full">
                <div class="center-desk">
                  <div class="logo">
                    <a href="#index"><img src="<?php echo base_url('assets/Admin/images/logo.png'); ?>" alt="#" /></a>
                  </div>
                </div>
              </div>
            </div>
     ...
     <!-- end header inner -->
     <!-- table -->
     <a href="<?php echo base_url('Login/versInfoEmpl'); ?>">
     <div class="limiter">
                ...
                <tr class="row100 body">
                    ...
                    <td class="cell100 column2">
                      <form class="news" action=<?php echo base_url('Login/versInfoEmpl/'); ?> method="POST">
                        <input type="hidden" name="idEmployee" value="<?php echo $liste[$i]['idEmployee'];?>" >
                        <button class="submit" name="" style= "background : transparent; color : gray; font-size : 18px; font-family : Calibri Light">
                          <?php echo $liste[$i]['prenomEmployee']; ?>
                        </button>
                        </form>
                    </td>
                    <td class="cell100 column3">
                      <form class="news" action=<?php echo base_url('Login/versInfoEmpl/'); ?> method="POST">
                        <input type="hidden" name="idEmployee" value="<?php echo $liste[$i]['idEmployee'];?>" >
                        <button class="submit" name="" style= "background : transparent; color : gray; font-size : 18px; font-family : Calibri Light">
                          <?php echo $liste[$i]['fonctionEmployee']; ?>
                        </button>
                        </form>
                    </td>
                    ...
                    <td class="cell100 column7">
                      <form class="news" action=<?php echo base_url('Login/deleteEmployee/'); ?> method="POST">
                        <input type="hidden" name="idEmployee" value="<?php echo $liste[$i]['idEmployee']; ?>" >
                        <input type="hidden" name="nomEmployee" value="<?php echo $liste[$i]['nomEmployee']; ?>" >
                        <input type="hidden" name="prenomEmployee" value="<?php echo $liste[$i]['prenomEmployee']; ?>" >
                        <input type="hidden" name="fonctionEmployee" value="<?php echo $liste[$i]['fonctionEmployee']; ?>" >
                        <input type="hidden" name="experience" value="<?php echo $liste[$i]['experience']; ?>" >
