    ...
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          <h1 class="fw-light"><?php echo $liste['nomCooperative']; ?></h1>
          <ul class="theme-list">
            <li><b>N° Certificat d'enregistrement:</b> <?php echo $liste['CE']; ?></li>
            <li><b>Date de création:</b> <?php echo $liste['DC']; ?></li>
            <li><b>Date d'enregistrement:</b> <?php echo $liste['DE']; ?></li>
            <li><b>Nom du président:</b> <?php echo $liste['nomPresident']; ?></li>
            <li><b>Nombres des membres:</b> <?php echo $liste['membre']; ?></li>
            <li><b>Homme(s):</b> <?php echo $liste['homme']; ?></li>
            <li><b>Femme(s):</b> <?php echo $liste['femme']; ?></li>
            <li><b>Contact:</b> <?php echo $liste['contact']; ?></li>
            <li><b>Branche:</b> <?php echo $liste['branche']; ?></li>
            <li><b>Activité(s) principale(s):</b> <?php echo $liste['filiere']; ?></li>
            <li><b>Siège sociale:</b> <?php echo $liste['addrescooperative']; ?></li>
            <li><b>Province:</b> <?php echo $liste['province']; ?></li>
            <li><b>Région:</b> <?php echo $liste['region']; ?></li>
            <li><b>District:</b> <?php echo $liste['distric']; ?></li>
            <li><b>Commune:</b> <?php echo $liste['commune']; ?></li>
            <li><b>Fokontany:</b> <?php echo $liste['fokotany']; ?></li>
          </ul>
