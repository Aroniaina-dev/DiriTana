<?php
  $testeImage = "../assets/SaryInfo/".$empl['prenomEmployee'].".jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="row">
        <div class="col-lg-4 py-3">
          <div class="img-place wow fadeInUp">
            <img src="<?php echo $testeImage; ?>" alt="">
          </div>
        </div>
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          <h1 class="fw-light"><?php echo $empl['nomEmployee']; echo "   ";echo $empl['prenomEmployee'] ?> </h1>
          <ul class="theme-list">
            <li><b>Fonction:</b> <?php echo $empl['fonctionEmployee']; ?></li>
            <li><b>Contact:</b> <?php echo $empl['contactEmployee']; ?></li>
            <li><b>E-Mail:</b> <?php echo $empl['mailEmployee']; ?></li>
            <li><b>Expérience:</b> <?php echo $empl['experience']; ?></li>
          </ul>
          <form class="news" action=<?php echo base_url('Login/ModifEmpl/'); ?> method="POST">
            <input type="hidden" name="idEmployee" value="<?php echo $empl['idEmployee']; ?>" >
            <button class="btn btn-theme-outline" type = "submit">Modifier</button>
          </form>
          <form class="news" action=<?php echo base_url('Login/deleteEmployee/'); ?> method="POST">
            <input type="hidden" name="idEmployee" value="<?php echo $empl['idEmployee']; ?>" >
            <input type="hidden" name="nomEmployee" value="<?php echo $empl['nomEmployee']; ?>" >
            <input type="hidden" name="prenomEmployee" value="<?php echo $empl['prenomEmployee']; ?>" >
            <input type="hidden" name="fonctionEmployee" value="<?php echo $empl['fonctionEmployee']; ?>" >
            <input type="hidden" name="experience" value="<?php echo $empl['experience']; ?>" >
          <button class="btn btn-theme-outline" type = "submit">Demission</button>
        </div>
      </div>
    </div>
